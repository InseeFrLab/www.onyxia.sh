const e={Header:{documentation:"Documentation","our instance":"Notre instance",contact:"Contacter l'équipe"},Footer:{"edit this website":"Modifier ce site"},Body:{"orange title":"La stack data science moderne rendue accessible","Onyxia in action":"Onyxia en action",subTitle:"Fournissez un environnement de travail à l'état de l'art à vos data scientists sans dépendre de logiciels propriétaires.","what is onyxia title":"Qu'est-ce qu'Onyxia?","what is onyxia body":`Onyxia est une application web qui permet aux 
    ...
    pleinement Onyxia et offrons tout notre soutien pour sa promotion.`,"Review slide Statistic Norway signature":"Statistics Norway, l'institut national de statistique de Norvège","Review slide ExpertiseFrance description":`Le  projet datafid, mis en œuvre par [Expertise France, a déployé Onyxia](https://www.expertisefrance.fr/en/fiche-projet?id=850376)  
