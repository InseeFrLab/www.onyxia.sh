const e={Header:{documentation:"Documentation","our instance":"Notre instance",contact:"Contacter l'équipe"},Footer:{"edit this website":"Modifier ce site"},Body:{"orange title":"La stack data science moderne rendue accessible","Onyxia in action":"Onyxia en action",subTitle:"Fournissez un environnement de travail à l'état de l'art à vos data scientists sans dépendre de logiciels propriétaires.","what is onyxia title":"Qu'est-ce qu'Onyxia?","what is onyxia body":`Onyxia est une application web qui permet aux 
        ...
        Onyxia propose également une intégration avec S3.`,"install now":"Guide de déploiment","article 1 title":"Construisez votre catalogue ou réutilisez les nôtres","article 1 body":`Construisez une offre de services sur mesure pour votre métier en mettant en place 
    votre propre dépôt de charts Helm ou réutilisez les nôtres : [interactive-services](https://github.com/InseeFrLab/helm-charts-interactive-services), [databases](https://github.com/InseeFrLab/helm-charts-databases), [automation](https://github.com/InseeFrLab/helm-charts-automation), ...`,"article 2 title":"Configuration des services","article 2 body":`Onyxia génère automatiquement un formulaire qui permet aux utilisateurs
    ...
    à son bucket personnel dès l'ouverture de Jupyter ou RStudio.`,"article 3 title":"Authentification et autorisation polyvalentes","article 3 body":`Onyxia s'intègre à votre système IAM existant. Que vous utilisiez [Keycloak](https://www.keycloak.org/), Microsoft [Entra ID](https://www.microsoft.com/en-us/security/business/identity-access/microsoft-entra-id), 
      [Auth0](https://auth0.com/) ou tout autre fournisseur compatible OpenID Connect/OAuth, Onyxia [s'y connecte en toute transparence](https://docs.onyxia.sh/admin-doc/openid-connect-configuration).`,"bp title 1":"Onyxia ne cherche pas à se rendre indispensable","bp description 1":`Nous visons à rendre les utilisateurs de la plateforme suffisamment 
        ...
        Cette fonctionalité peut être utilisée pour créer des catalogues de formations comme [celui-là](https://www.sspcloud.fr/catalog).`,"bp title 6":"Technologiquement agnostique","bp description 6":`Avec Onyxia vous n'investissez pas sur une stack technique en particulier sauf Kubernetes et S3.
    ...
    ses fonctionnalités.`,"Review slide insee signature":"Jean-Séverin Lair, DSI de l'Insee","Review slide Mercator description":`[Mercator Ocean International](https://www.mercator-ocean.eu/) est une organisation à but non lucratif qui fournit des 
    ...
    `,"Review slide Mercator signature":"Chloé Delpont Ramat, Full Stack Dev @ Mercator Ocean International","Review slide Statistic Norway description":`[Statistics Norway](https://www.ssb.no/en) est ravi d'intégrer Onyxia en tant que composant clé de notre plateforme de données. 
    ...
    pleinement Onyxia et offrons tout notre soutien pour sa promotion.`,"Review slide Statistic Norway signature":"Statistics Norway, l'institut national de statistique de Norvège","Review slide ExpertiseFrance description":`Le  projet datafid, mis en œuvre par [Expertise France, a déployé Onyxia](https://www.expertisefrance.fr/en/our-projects)  
    ...
    `,"Review slide ExpertiseFrance signature":"Expertise France, l'agence française d'expertise technique internationale","Review slide Genes description":`Onyxia est un atout majeur pour [le Groupe des Écoles Nationales d'Économie et Statistique (GENES)](https://www.groupe-genes.fr) en matière de data science.  
    ...
    `,"Review slide Genes signature":"Groupe des Écoles Nationales d'Économie et Statistique (GENES)"},LogoCarousel:{"read testimonials":"Lire les témoignages"}};export{e as translations};
